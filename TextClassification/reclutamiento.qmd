...
:::: {.columns}
::: {.column width="40%"}
![](img/validacion req.png){height=350}
:::
::: {.column width="60%"}
::: {.callout-tip icon="false"}
### @santana2024estudio
...
:::: {.columns}
::: {.column width="40%"}
![](img/turismo_opinion.png){height=350}
:::
::: {.column width="60%"}
::: {.callout-tip icon="false"}
...
* Análisis de sentimiento para detectar competencias blandas
...
::: {.column} 
![](img/mineria_opinion_tasks.png){fig-align="center" width="50%"}
::: 
## Preprocesamiento 
...
:::: {.columns}
::: {.column width="40%"}
![](img/redes sociales.jpg){height=350}
:::
...
::: {.column width="40%"}
![](img/reseña productos.png){height=253}
