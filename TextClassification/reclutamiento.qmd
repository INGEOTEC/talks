---
lang: es
title: "Aplicación del Procesamiento de Lenguaje Natural para Tareas de Reclutamiento y Marketing"
...
## Conducción autónoma - 2004

::: {.callout-tip icon="false"}
### [Defense Advanced Research Projects Agency (DARPA)](https://www.darpa.mil/news/2014/grand-challenge-ten-years-later)
:::: {.columns}
::: {.column}
...
## Competencia de [Netflix](https://www.kaggle.com/datasets/netflix-inc/netflix-prize-data) - 2000
...
## [Codabench](https://www.codabench.org) - 2013
...
* Tercera edición nació AlexNet
* CNN, VGG, GoogLeNet
:::

::: {.callout-tip icon="false" .fragment}
### [AutoML 2025](https://2025.automl.cc)

* Automatizar el ciclo de aprendizaje computacional
* Competencias 2015 - 2018
* Datos tabulares
:::
...
::: {.callout-tip icon="false"}
### [ICDAR 2025](https://www.icdar2025.com/program/competitions)
![](img/ICDAR.jpeg)
:::


## Text Retrieval Conference (TREC) - 1990
...
## Conference and Labs of the Evaluation Forum - 2000

::: {.callout-tip icon="false"}
### [CLEF](https://www.clef-initiative.eu)
![](img/clef.png){fig-align="center" height=300}
:::

## Semantic Evaluation ([SemEval](https://semeval.github.io)) 

::: {.callout-tip icon="false"}
### [SemEval 2025](https://semeval.github.io/SemEval2025/) ([2026](https://semeval.github.io/SemEval2026))

* Semantic Relations
  - Entity-aware machine translation
* LLM Capabilities
  - Unlearning sensitive content from LLM
* Fact Checking and Knowledge Verification
  - Question-Answering over Tabular Data
* Knowledge Representation and Reasoning
  - Bringing the Gap in Text-Based Emotion Detection
:::
...
::: {.callout-tip icon="false"}
### [IberLEF 2025](https://sites.google.com/view/iberlef-2025/)
![](img/iberlef.jpeg)
:::
...
::: {.callout-tip icon="false"}
### [Dravidian-CodeMix](https://sites.google.com/view/dravidian-codemix-fire2024/home)
![](img/fire2024.jpeg)
:::
