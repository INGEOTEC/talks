...
format:
  ...
  #  html:
  #    page-layout: full
    site-url: https://ingeotec.github.io/IberLEF2023
    repo-url: https://github.com/INGEOTEC/IberLEF2023
    downloads: pdf
...
Violence is a serious problem that can have a devastating impact on individuals and communities. In some cases, the virtual world is prone to aggressive expressions and insults, among other violent expressions.
...
This presentation describes our solution system for the (i) track using **only text-based features**. More particularly, we used our **EvoMSA** framework. We achieved an F1 score of 0.89, just 3 hundredths behind the best model in the final ranking.
