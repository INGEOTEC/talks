...
##
Creados con fast text sobre nuestra corpora regionalizada de Twitter. Disponibles desde el **sitio** del proyecto en diferentes dimensiones, e.g, 300, 32, 16 y 8 dimensiones.
...
![](https://github.com/INGEOTEC/regional-spanish-models/raw/main/figs/fig-common-words-semantic-affinity-matrix.png) 

##
![](https://github.com/INGEOTEC/regional-spanish-models/raw/main/figs/fig-colormap-common-voc-semantic-4.png){.absolute top=0 left=400}   ![](https://raw.githubusercontent.com/sadit/RegionalSpanish/main/figs/fig-voc-semantic-umap-4.png){.absolute top=250 left=10}  
